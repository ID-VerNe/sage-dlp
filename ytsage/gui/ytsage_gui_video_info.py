...
class VideoInfoMixin:
    def setup_video_info_section(self) -> QHBoxLayout:
        ...
        self.thumbnail_label.setStyleSheet("border: 2px solid #dfe6e9; border-radius: 4px;")
        ...
        self.subtitle_select_btn.setStyleSheet(
            ...
            QPushButton:hover { background-color: #d0e4fa; }
        ...
        self.selected_subs_label.setStyleSheet("color: #636e72; padding-left: 5px;")
        ...
        self.selected_sponsorblock_label.setStyleSheet("color: #636e72; padding-left: 5px;")
