...
class DownloadSettingsDialog(QDialog):
    def __init__(self, current_path, current_limit, current_unit_index, parent=None) -> None:
        ...
        self.path_display.setStyleSheet(
            "QLabel { color: #2d3436; padding: 5px; border: 1px solid #b0bec5; border-radius: 4px; background-color: #f0f2f5; }"
        )
        ...
        connections_help_label.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
        ...
        generic_mode_help_label.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
        ...
        format_label.setStyleSheet("color: #2d3436; margin-top: 5px;")
        ...
        help_label.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
        ...
        audio_norm_help_label.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
        ...
        audio_format_label.setStyleSheet("color: #2d3436; margin-top: 5px;")
        ...
        audio_help_label.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
        ...
        vid_qual_label.setStyleSheet("color: #2d3436; margin-top: 5px;")
        ...
        sub_label.setStyleSheet("color: #2d3436; margin-top: 5px;")
        ...
        defaults_help.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
        ...
        filename_help_label.setStyleSheet("color: #636e72; margin: 5px; font-size: 11px;")
...
class AutoUpdateSettingsDialog(QDialog):
    ...
    def init_ui(self) -> None:
        ...
        desc_label.setStyleSheet("color: #636e72; margin: 10px; font-size: 11px;")
