...
class UpdaterTabWidget(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        help_text.setStyleSheet("color: #636e72; padding: 10px;")
        ...
        current_label.setStyleSheet("font-weight: bold; color: #2d3436;")
        current_layout.addWidget(current_label)
        
        self.current_version_label = QLabel("...")
        self.current_version_label.setStyleSheet("color: #636e72;")
        ...
        latest_label.setStyleSheet("font-weight: bold; color: #2d3436;")
        latest_layout.addWidget(latest_label)
        
        self.latest_version_label = QLabel("...")
        self.latest_version_label.setStyleSheet("color: #636e72;")
        ...
        self.status_label.setStyleSheet(
            "color: #636e72; font-size: 12px; padding: 8px; "
            "background-color: #e8f0fe; border-radius: 4px; margin: 5px 0;"
        )
        ...
        deno_desc.setStyleSheet("color: #636e72; padding: 10px;")
        ...
        deno_current_label.setStyleSheet("font-weight: bold; color: #2d3436;")
        deno_current_layout.addWidget(deno_current_label)
        
        self.deno_current_version_label = QLabel("...")
        self.deno_current_version_label.setStyleSheet("color: #636e72;")
        ...
        deno_latest_label.setStyleSheet("font-weight: bold; color: #2d3436;")
        deno_latest_layout.addWidget(deno_latest_label)
        
        self.deno_latest_version_label = QLabel("...")
        self.deno_latest_version_label.setStyleSheet("color: #636e72;")
        ...
        channel_desc.setStyleSheet("color: #636e72; font-size: 11px; padding: 2px;")
        ...
        self.channel_status_label.setStyleSheet(
            "color: #636e72; font-size: 11px; padding: 5px; "
            "background-color: #e8f0fe; border-radius: 4px; margin: 5px 0;"
        )
        ...
        self.auto_update_enabled.setStyleSheet(
            ...
            QCheckBox:disabled { color: #636e72; }
        ...
        frequency_label.setStyleSheet("color: #2d3436; margin-top: 10px;")
