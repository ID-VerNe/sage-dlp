"""
Settings-related dialogs for SageDLP application.
...
class DownloadSettingsDialog(QDialog):
    def __init__(self, current_path, current_limit, current_unit_index, parent=None) -> None:
        ...
        self.path_display.setStyleSheet(
            "QLabel { color: #0f172a; padding: 5px; border: 1px solid #cbd5e1; border-radius: 8px; background-color: #f8fafc; }"
        )
        ...
        # --- Connections Section ---
        connections_group_box = QGroupBox(_("settings.concurrent_fragments"))
        ...
        connections_help_label = QLabel(_("settings.concurrent_fragments_help"))
        connections_help_label.setWordWrap(True)
        connections_help_label.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        generic_mode_help_label.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        format_label.setStyleSheet("color: #0f172a; margin-top: 5px;")
        ...
        help_label.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        self.audio_normalization_checkbox = QCheckBox(_("settings.audio_normalization"))
        ...
        audio_norm_help_label = QLabel(_("settings.audio_normalization_help"))
        audio_norm_help_label.setWordWrap(True)
        audio_norm_help_label.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        audio_format_label.setStyleSheet("color: #0f172a; margin-top: 5px;")
        ...
        audio_help_label.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        defaults_group_box = QGroupBox(_("settings.defaults_settings"))
        defaults_layout = QVBoxLayout()

        # Default Video Quality
        vid_qual_layout = QHBoxLayout()
        vid_qual_label = QLabel(_("settings.default_video_quality"))
        vid_qual_label.setStyleSheet("color: #0f172a; margin-top: 5px;")
        ...
        sub_label = QLabel(_("settings.default_subtitle_language"))
        sub_label.setStyleSheet("color: #0f172a; margin-top: 5px;")
        ...
        defaults_help = QLabel(_("settings.defaults_help"))
        defaults_help.setWordWrap(True)
        defaults_help.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        filename_help_label.setStyleSheet("color: #64748b; margin: 5px; font-size: 11px;")
        ...
        self.tab_widget.addTab(general_tab, _("settings.tab_general"))
        self.tab_widget.addTab(format_tab, _("settings.tab_format"))
        self.tab_widget.addTab(file_tab, _("settings.tab_file"))
        ...
        for btn in [ok_button, cancel_button]:
            ...
            btn.setStyleSheet(primary_button_qss(min_width="80px"))
    ...
    def _create_styled_message_box(self, icon, title, text) -> QMessageBox:
        ...
        msg_box.setStyleSheet(message_box_qss())
        return msg_box
...
class AutoUpdateSettingsDialog(QDialog):
    ...
    def init_ui(self) -> None:
        ...
        # Title
        header_text = _("settings.auto_update_header")
        title_label = QLabel(f"<h2>{header_text}</h2>")
        ...
        desc_label.setStyleSheet("color: #64748b; margin: 10px; font-size: 11px;")
        ...
        self.manual_check_btn.setStyleSheet(primary_button_qss())
