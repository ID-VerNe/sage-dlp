"""
Custom functionality dialogs for SageDLP application.
...
if TYPE_CHECKING:
    from ..sage_gui_main import SageApp  # only for type hints (no runtime import)
...
class CustomOptionsDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        self._parent: SageApp = cast("SageApp", self.parent())  # cast will help with auto complete and type hint checking.
        ...
        browser_help.setStyleSheet("color: #64748b; font-size: 11px;")
        ...
        self.remember_cb.setStyleSheet(checkbox_qss() + " QCheckBox { padding: 10px 5px; }")
        ...
        self.apply_cookies_btn.setStyleSheet(primary_button_qss(min_width="100px"))
        ...
        proxy_help_text.setStyleSheet("color: #64748b; padding: 10px;")
        ...
        main_proxy_help.setStyleSheet("color: #64748b; font-size: 11px;")
        ...
        example_label.setStyleSheet("color: #64748b; font-size: 10px; font-style: italic;")
        ...
        geo_proxy_help.setStyleSheet("color: #64748b; font-size: 11px;")
        ...
        self.proxy_status.setStyleSheet("color: #64748b; font-style: italic;")
        ...
        clear_main_proxy_btn.setStyleSheet(primary_button_qss())
        ...
        clear_geo_proxy_btn.setStyleSheet(primary_button_qss())
        ...
        language_help_text.setStyleSheet("color: #0f172a; font-size: 14px; font-weight: bold; padding: 10px;")
        ...
        current_lang_label.setStyleSheet("color: #64748b; padding: 10px;")
        ...
        self.restart_notice.setStyleSheet(
            ...
            "background-color: #eff4fa; border-radius: 8px; margin: 10px;"
        )
        ...
        llm_help.setStyleSheet("color: #475569; padding: 10px;")
        ...
        self.llm_url_input.setToolTip(_("llm.api_url_tooltip"))
        ...
        self.llm_api_key_input.setToolTip(_("llm.api_key_tooltip"))
        api_key_layout.addWidget(self.llm_api_key_input)
        api_layout.addLayout(api_key_layout)
        llm_layout.addWidget(api_group)

        # Model group
        model_group = QGroupBox(_("llm.model_group"))
        model_layout = QVBoxLayout(model_group)

        # Model name
        model_row = QHBoxLayout()
        model_row.addWidget(QLabel(_("llm.model")))
        self.llm_model_input = QLineEdit()
        self.llm_model_input.setText(ConfigManager.get("llm_model") or "gpt-4.1")
        self.llm_model_input.setPlaceholderText(_("llm.model_placeholder"))
        self.llm_model_input.setToolTip(_("llm.model_tooltip"))
        model_row.addWidget(self.llm_model_input)
        model_layout.addLayout(model_row)

        # Temperature (full width with slider-like appearance)
        temp_row = QHBoxLayout()
        temp_row.addWidget(QLabel(_("llm.temperature")))
        ...
        self.llm_temperature_input.setToolTip(_("llm.temperature_tooltip"))
        temp_row.addWidget(self.llm_temperature_input)
        temp_label = QLabel(_("llm.temperature_unit"))
        temp_label.setStyleSheet("color: #64748b; font-size: 12px;")
        ...
        # Advanced group
        adv_group = QGroupBox(_("llm.adv_group"))
        adv_layout = QVBoxLayout(adv_group)

        # Timeout + Max Retries row
        params_row1 = QHBoxLayout()
        params_row1.addWidget(QLabel(_("llm.timeout")))
        ...
        self.llm_timeout_input.setToolTip(_("llm.timeout_tooltip"))
        params_row1.addWidget(self.llm_timeout_input)
        timeout_unit = QLabel(_("llm.timeout_unit"))
        timeout_unit.setStyleSheet("color: #64748b; font-size: 12px;")
        params_row1.addWidget(timeout_unit)
        params_row1.addStretch()
        params_row1.addWidget(QLabel(_("llm.max_retries")))
        ...
        self.llm_max_retries_input.setToolTip(_("llm.max_retries_tooltip"))
        params_row1.addWidget(self.llm_max_retries_input)
        adv_layout.addLayout(params_row1)

        # Max Workers row
        workers_row = QHBoxLayout()
        workers_row.addWidget(QLabel(_("llm.max_workers")))
        ...
        self.llm_max_workers_input.setToolTip(_("llm.max_workers_tooltip"))
        workers_row.addWidget(self.llm_max_workers_input)
        workers_label = QLabel(_("llm.workers_unit"))
        workers_label.setStyleSheet("color: #64748b; font-size: 12px;")
        workers_row.addWidget(workers_label)
        workers_row.addStretch()
        adv_layout.addLayout(workers_row)
        llm_layout.addWidget(adv_group)

        # Segmentation parameters group
        seg_group = QGroupBox(_("llm.seg_title"))
        seg_layout = QVBoxLayout(seg_group)

        # Soft limit + Hard limit row
        seg_row1 = QHBoxLayout()
        seg_row1.addWidget(QLabel(_("llm.soft_limit")))
        ...
        self.llm_soft_limit.setToolTip(_("llm.soft_limit_tooltip"))
        seg_row1.addWidget(self.llm_soft_limit)
        soft_unit = QLabel(_("llm.limit_unit"))
        soft_unit.setStyleSheet("color: #64748b; font-size: 12px;")
        seg_row1.addWidget(soft_unit)
        seg_row1.addStretch()
        seg_row1.addWidget(QLabel(_("llm.hard_limit")))
        ...
        self.llm_hard_limit.setToolTip(_("llm.hard_limit_tooltip"))
        seg_row1.addWidget(self.llm_hard_limit)
        hard_unit = QLabel(_("llm.limit_unit"))
        hard_unit.setStyleSheet("color: #64748b; font-size: 12px;")
        seg_row1.addWidget(hard_unit)
        seg_layout.addLayout(seg_row1)

        # Target CPS + Limit CPS row
        seg_row2 = QHBoxLayout()
        seg_row2.addWidget(QLabel(_("llm.target_cps")))
        ...
        self.llm_target_cps.setToolTip(_("llm.target_cps_tooltip"))
        seg_row2.addWidget(self.llm_target_cps)
        cps_unit = QLabel(_("llm.cps_unit"))
        cps_unit.setStyleSheet("color: #64748b; font-size: 12px;")
        seg_row2.addWidget(cps_unit)
        seg_row2.addStretch()
        seg_row2.addWidget(QLabel(_("llm.limit_cps")))
        ...
        self.llm_limit_cps.setToolTip(_("llm.limit_cps_tooltip"))
        seg_row2.addWidget(self.llm_limit_cps)
        limit_cps_unit = QLabel(_("llm.cps_unit"))
        limit_cps_unit.setStyleSheet("color: #64748b; font-size: 12px;")
        seg_row2.addWidget(limit_cps_unit)
        ...
        # Apply global styles (Daylight theme) via shared tokens
        self.setStyleSheet(
            dialog_base_qss()
            + tab_widget_qss()
            + groupbox_qss()
    ...
    def _update_cookies_active_status(self) -> None:
        ...
        if hasattr(self._parent, "browser_cookies_option") and self._parent.browser_cookies_option:
            ...
            self.cookies_active_status.setStyleSheet("color: #64748b; font-style: italic;")
