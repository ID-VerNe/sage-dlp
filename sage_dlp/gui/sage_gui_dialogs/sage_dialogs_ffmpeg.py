"""
FFmpeg installation dialogs for SageDLP application.
...
from ...core.sage_ffmpeg import auto_install_ffmpeg, check_ffmpeg_installed
from ...utils.sage_constants import ICON_PATH
from ...utils.sage_localization import _
from .sage_dialogs_base import primary_button_qss, dialog_base_qss
...
class FFmpegCheckDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        self.message_label.setStyleSheet("font-size: 13px; color: #64748b; padding: 10px 0; line-height: 1.4;")
