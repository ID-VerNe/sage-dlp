...
class SageApp(QMainWindow, FormatTableMixin, VideoInfoMixin, AnalysisMixin):  # Inherit from mixins
    ...
    def show_update_dialog(self, latest_version, release_url, changelog) -> None:  # Added changelog parameter
        ...
        try:
            if self.windowIcon() and not self.windowIcon().isNull():
                ...
                # icon_path logic moved to src\utils\sage_constants.py
                if ICON_PATH.exists():
    ...
    @Slot(str, str)
    def _on_cookies_received_from_extension(self, cookie_file: str, url: str) -> None:
        """
