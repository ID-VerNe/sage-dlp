...
history in SageDLP using SQLite for high performance and scalability.
...
Usage
-----
from .sage_history_manager import HistoryManager
...
from .sage_constants import APP_HISTORY_FILE, APP_DATA_DIR
from .sage_logger import logger


class HistoryManager:
    """
    Thread-safe history manager for SageDLP using SQLite.
    """
