...
configuration in SageDLP. It handles reading, writing, and managing settings
...
Usage
-----
from .sage_config_manager import ConfigManager
...
from .sage_constants import APP_CONFIG_FILE, USER_HOME_DIR
from .sage_logger import logger


class ConfigManager:
    """
    Thread-safe configuration manager for SageDLP.
    ...
    _default_config: Dict[str, Any] = {
        ...
        "llm_timeout": 60,
        "llm_max_retries": 3,
        "llm_segmentation_soft_limit": 70,
        "llm_segmentation_hard_limit": 85,
        "llm_segmentation_target_cps": 14,
        "llm_segmentation_limit_cps": 18,
    }
