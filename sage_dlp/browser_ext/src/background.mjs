...
// ---------------------------------------------------------------------------
const YTSAGE_SERVER_URL = 'http://127.0.0.1:9876/api/cookies';
...
const serializeNetscape = (cookies) => {
  const lines = [
    ...
    '# This file was auto-generated by Get cookies.txt LOCALLY (SageDLP bridge)',
  ];
