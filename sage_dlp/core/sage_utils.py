...
from .sage_ffmpeg import check_ffmpeg_installed, get_ffmpeg_install_path
...
# get_app_data_dir() moved to src\utils\sage_constants.py
# get_config_file_path() moved to src\utils\sage_constants.py
# ensure_app_data_dir() moved to src\utils\sage_constants.py
...
def check_ffmpeg() -> bool:
    ...
    try:
        # Use the enhanced FFmpeg check from sage_ffmpeg
...
def validate_video_url(url: str, generic_mode: bool = False) -> tuple[bool, str]:
    ...
    # SageDLP focuses on YouTube and YouTube Music only
