...
<img src="../branding/screenshots/main.png" width="800" alt="SageDLP 界面"/>

[![Python 3.10+](https://img.shields.io/badge/python-3.10+-1f2937?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/downloads/)
[![PyPI 下载量](https://img.shields.io/pepy/dt/sage-dlp?color=1f2937&style=for-the-badge&label=downloads&logo=python&logoColor=white)](https://pepy.tech/project/sage-dlp)
[![GitHub 下载量](https://img.shields.io/github/downloads/oop7/SageDLP/total?color=1f2937&style=for-the-badge&label=downloads&logo=github&logoColor=white)](https://github.com/oop7/SageDLP/releases)
...
[![支持平台](https://img.shields.io/badge/platform-cross--platform-1f2937?style=for-the-badge&logo=github&logoColor=white)](https://github.com/oop7/SageDLP/releases)
...
[![PyPI 版本](https://img.shields.io/pypi/v/sage-dlp?color=c90000&style=for-the-badge&logo=pypi&logoColor=white)](https://pypi.org/project/sage-dlp/)
...
<a id="为什么选择-sage-dlp"></a>
## ❓ 为什么选择 SageDLP?

SageDLP 专为寻找 **简单但强大** 的 YouTube 下载器的用户而设计。与其他工具不同，它提供：
...
> [👉 下载最新版本](https://github.com/oop7/SageDLP/releases/latest)
...
2. **便携版 (`.zip`)**: 解压到所需位置并运行 `sage-dlp.exe`。
...
- **DMG 安装程序 (`.dmg`)**: 双击挂载，然后将 `SageDLP.app` 拖入 Applications 文件夹。
- **ZIP 应用包 (`.zip`)**: 解压并移动 `SageDLP.app` 到 Applications 文件夹。
...
- 通用模式仅关闭了 SageDLP 内部的 URL 类型检查。网站支持程度仍取决于您安装的 yt-dlp。
...
SageDLP 支持 **14 种语言**。您可以在 **Custom Options → Language** 中更改。
...
- **常见特定的错误提示:**
  ...
  - **地理锁定:** 需使用代理或 VPN。
  - **视频已删除:** 视频已不存在。
  - **直播内容:** SageDLP 目前不支持实时直播下载，请等直播结束后再试。
...
**安全建议:**
- ✅ **通过 pip 安装:** `pip install sage-dlp`（推荐）
...
2. 输入命令 (结尾有一个空格):
   ...
   ```
3. 从 Finder 中将 **SageDLP.app** 拖入终端窗口。
4. 按回车。
5. 再次打开应用。
...
如果 SageDLP 节省了您的时间，请考虑资助本项目。赞助收入将用于多平台测试环境的维护和新功能开发。

- GitHub Sponsors: https://github.com/sponsors/oop7
- 您也可以通过应用内的“About (关于)”窗口找到捐赠链接。

[![赞助 SageDLP](https://img.shields.io/badge/Sponsor-SageDLP-EA4AAA?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sponsors/oop7)
...
- 也可以翻译界面词条：`sage-dlp/languages/<语言代码>.json`。
