...
SageDLP उन उपयोगकर्ताओं के लिए डिज़ाइन किया गया है जो एक **सरल लेकिन शक्तिशाली YouTube डाउनलोडर** चाहते हैं। अन्य उपकरणों के विपरीत, यह प्रदान करता है:
...
PyPI के माध्यम से SageDLP स्थापित करें:
...
> [👉 नवीनतम रिलीज़ डाउनलोड करें](https://github.com/oop7/SageDLP/releases/latest)
...
2. **पोर्टेबल संस्करण (`.zip`)**: संग्रह को इच्छित स्थान पर निकालें और `sage-dlp.exe` चलाएँ।
...
- **DMG इंस्टॉलर (`.dmg`)**: माउंट करने के लिए डबल-क्लिक करें, फिर `SageDLP.app` को अपने एप्लिकेशन फ़ोल्डर में खींचें।
- **ऐप आर्काइव (`.zip`)**: ज़िप निकालें और `SageDLP.app` को अपने एप्लिकेशन फ़ोल्डर में ले जाएँ।
...
जेनेरिक मोड (Generic Mode) का उपयोग तब करें जब आप चाहते हैं कि SageDLP yt-dlp द्वारा समर्थित साइटों जैसे Dailymotion, CBC Gem, TikTok और अन्य से URL स्वीकार करे।
...
- जेनेरिक मोड केवल SageDLP के अंदर URL सत्यापन को बदलता है। लक्ष्य साइट अभी भी आपके स्थापित yt-dlp संस्करण द्वारा समर्थित होनी चाहिए।
...
- **जेनेरिक मोड:** SageDLP को yt-dlp द्वारा समर्थित गैर-YouTube साइटों से विश्लेषण और डाउनलोड करने की अनुमति देता है। इसे **Download Settings → Generic Mode** से सक्षम करें।
...
SageDLP वैश्विक पहुँच के लिए **14 भाषाओं** का समर्थन करता है। **Custom Options → Language** में अपनी पसंदीदा भाषा चुनें।
...
- **डाउनलोड के बाद वीडियो और ऑडियो फ़ाइलें अलग हैं:** यह तब होता है जब FFmpeg गायब होता है या पता नहीं चल पाता है। उच्च गुणवत्ता वाले वीडियो और ऑडियो स्ट्रीम को मर्ज करने के लिए SageDLP को FFmpeg की आवश्यकता होती है।
  - **समाधान:** सुनिश्चित करें कि FFmpeg स्थापित है और आपके सिस्टम PATH में सुलभ है। विंडोज उपयोगकर्ताओं के लिए, सबसे आसान विकल्प `SageDLP-v<version>-ffmpeg.exe` फ़ाइल डाउनलोड करना है, जो FFmpeg के साथ आती है।
...
**सुरक्षित विकल्प:**
- ✅ **pip स्थापना का उपयोग करें:** `pip install sage-dlp` (अनुशंसित)
...
2.  **निम्न कमांड टाइप करें** लेकिन अभी Enter **न दबाएँ**। सुनिश्चित करें कि अंत में स्थान शामिल है:
    ...
    ```
3.  **अपनी फाइंडर विंडो से `SageDLP.app` फ़ाइल खींचें** और इसे सीधे टर्मिनल विंडो में छोड़ें। यह स्वचालित रूप से सही फ़ाइल पथ पेस्ट कर देगा।
4.  **Enter दबाएँ** कमांड चलाने के लिए।
5.  **SageDLP.app को फिर से खोलने का प्रयास करें।** इसे अब ठीक से लॉन्च होना चाहिए।
...
यदि SageDLP आपका समय बचाता है, तो कृपया प्रोजेक्ट को प्रायोजित करने पर विचार करें। प्रायोजन विकास समय, सभी प्लेटफ़ॉर्म पर परीक्षण और भविष्य के सुधारों को कवर करने में मदद करता है।
...
- `sage-dlp/languages/<code>.json` को संपादित करके ऐप स्ट्रिंग्स को सिंक में रखें
- यदि आपकी भाषा गायब है, तो `README.md` से शुरू करें और `README.<code>.md` बनाएँ

<details>
<summary>📂 प्रोजेक्ट संरचना</summary>

## SageDLP - प्रोजेक्ट संरचना

यह दस्तावेज़ SageDLP की संगठित फ़ोल्डर संरचना का वर्णन करता है।
...
└── 📁 sage-dlp/                    # स्रोत कोड पैकेज
    ...
    │   ├── 📄 __init__.py        
    │   ├── 📄 sage-dlp_deno.py     # Deno एकीकरण
    │   ├── 📄 sage-dlp_downloader.py # डाउनलोड कार्यक्षमता
    │   ├── 📄 sage-dlp_ffmpeg.py   # FFmpeg एकीकरण
    │   ├── 📄 sage-dlp_utils.py    # उपयोगिता कार्य
    │   └── 📄 sage-dlp_yt_dlp.py   # yt-dlp एकीकरण
    ├── 📁 gui/                   # यूजर इंटरफेस घटक
    │   ├── 📄 __init__.py        
    │   ├── 📄 sage-dlp_gui_main.py # ऐप की मुख्य विंडो
    │   └── 📁 sage-dlp_gui_dialogs/ # संवाद वर्ग
    ├── 📁 utils/                 # उपयोगिता मॉड्यूल
    │   ├── 📄 __init__.py        
    │   ├── 📄 sage-dlp_config_manager.py # कॉन्फ़िगरेशन प्रबंधन
    │   └── 📄 sage-dlp_logger.py   # लॉगिंग टूल
